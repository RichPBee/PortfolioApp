    ...
    return (
        ...
        <div className="ProjectsSection PageSection" id="Projects">
            ...
            <ProjectCard 
                ...
                aboutText = "An ElectronJS app that automates the process of launching local servers and engines for casino games at L&W. The app looks for files in default paths in a user's computer to determine launchable games, and also provides options for configuring the search directories. Using Selenium webdriver, a user-defined csv config and a zsh script, the tool is then able to launch a game engine and web page for play-testing and developing game clients, without the need to manually use the terminal. "
            ...
            <ProjectCard 
                ...
                aboutText = "A basic modular framework for building web pages. It utilises a view controller to switch between pages, and a re-usable component design. This was primarily built as a learning project, and isn't fully fleshed out, but it has the basic functionality for displaying a web page and setting up different views."
